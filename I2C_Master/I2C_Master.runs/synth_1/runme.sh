...
HD_PWD='C:/Users/Dennis Wong/Documents/FPGA_Projects/I2C_Controller/I2C_Master/I2C_Master.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_test.tcl
