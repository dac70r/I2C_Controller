...
HD_PWD='C:/Users/Dennis Wong/Documents/FPGA_Projects/I2C_Controller/I2C_Master/I2C_Master.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_test.tcl -notrace
